...
<!--Header Top Layer Section-->	
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-6 search-bar-top">
			<label for="s"> Zone de recherche</label>
			<?php get_search_form(); ?>
			</div>
		</div>	
	</div>
...
<div class="navbar navbar-wrapper navbar-inverse navbar-static-top" role="navigation">
		...
		<a class="navbar-brand" href="<?php echo esc_url( home_url( '/' )); ?>">
			<?php
				...
				<?php } ?>
			<img class="img-responsive" src="https://strasbourgtourisme.antoine-libert.com/wp-content/uploads/2018/04/Logo_office-e1524562761864-768x370.png" alt="logo de l'office de Tourisme de Strasbourg">	
			</a>
		</a><!-- /logo -->
