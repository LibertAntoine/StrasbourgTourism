...
<div class="container home-blog-section">
	<div class="row">
		<div class="section_heading_title">
			<h1>Retrouver ici toutes les informations essentielles sur la ville de Strasbourg.</h1>
	...
	<div class="row">
		<?php
		$j=1;
		$args = array( 'post_type' => 'plus_infos','posts_per_page' =>10,'post__not_in'=>get_option("sticky_posts")); 	
		query_posts( $args );
		if(query_posts( $args ))
